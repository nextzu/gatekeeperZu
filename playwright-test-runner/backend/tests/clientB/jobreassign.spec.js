...
test('test', async ({ page }) => {
  ...
  try {
    await expect(page.getByText('Job Status has been updated')).toBeVisible({timeout:5000});
    console.log("Reassigned job appeared successfully.");
  }catch{
    throw new Error("Reassigned job not found on the page.");
  }
});
